...
#define PIXEL_PLAY_STUDIOS_WAIT_FRAMES 600
#define FINAL_TRANSITION_WAIT_FRAMES 110

//enums
enum IntroState{
	GBAJAM_ENTER, GBAJAM_HOLD, GBAJAM_LEAVE, AUDIO_ENGINE_ENTER, AUDIO_ENGINE_HOLD, AUDIO_ENGINE_LEAVE, STUDIO_ENTER, STUDIO_HOLD, STUDIO_LEAVE, BEFORE_FINAL_TRANSITION
};
