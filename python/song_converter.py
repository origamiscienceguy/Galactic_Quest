...
audioAssets.write("//This file is automatically generated by [song_converter.py]. Do not edit manually.\n#ifndef audioAssetEnumh\n#define audioAssetEnumh\n\nenum AudioAssetName{\n\t")
...
#delete every song file
processedSongListDelete = os.listdir(processedSongDir)
for currentProcessedSongFile in processedSongListDelete:
	os.remove(os.path.join(processedSongDir, currentProcessedSongFile))
gitignore = open(os.path.join(processedSongDir, '.gitkeep'), "w")
gitignore.close()
...
#write an enum for every song
for i in range(len(processedSongList)):
	audioAssets.write(processedSongList[i] + ", ")
audioAssets.write("\n};\n\n#endif")
